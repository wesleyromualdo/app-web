...
VALUES('00000000191', 'Administrador Solver', '$2b$12$rfnrdFhgKa7RDiXtxTidU.s5k4yj5W4pFRyg5Zh8w2uzPsNkO92qq', 'roborpabsb@gmail.com', true, now());
...
VALUES('00000000191', (SELECT id FROM setor s WHERE tx_sigla = 'Solver'));
...
INSERT INTO public.menu(nu_codigo, tx_nome, tx_link, tx_icon, nu_ordem, bo_status) VALUES(3000, 'Gestão de executor', '/automacao', 'settings', 3, true);
...
INSERT INTO public.menu(nu_codigo, tx_nome, tx_link, tx_icon, nu_ordem, bo_status) VALUES(7000, 'Cadastro de Cliente', '/setor', 'supervised_user_circle', 7, true);
